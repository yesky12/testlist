...
//		c.haveAuthManager();
	...
	public void selectiveAuthManager(){
		System.out.println("the loginer's name is not gonglin,so have no permites do manager except to query operator...");
	...
	public void haveNoAuthManager(){
		System.out.println("the loginer's name is not gonglin,so have no permits do manager...");
	...
	public void haveAuthManager(){
		System.out.println("the loginer's name is gonglin,so have permits do manager...");
		InfoManager noAuthManager=InfoManagerFactory.getinstance(new AuthProxy("gonglin"));
		doCRUD(noAuthManager);
		separatorLine();
	}
